describe("Automation Test of MPost website", () => {
  ...
  // -------------------------------------------- Test 2---------------------------------------------
  it("should display all partner logos correctly  and the footer", () => {
    // Validate Global Challenge Section
  ...
  it("Should navigate the page using the Bottom Navigation bar buttons", () => {
  ...
  it("Should Navigate the MPost Home Page section per section", () => {
    // Assert on the banner’s visibility
